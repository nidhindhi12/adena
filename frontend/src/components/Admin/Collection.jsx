    ...
    return (
        <div className=' spacer'>
            <Container className=' px-0'>
                <h1 style={{ fontFamily: 'var(--secondary-font)', color: "var(--icon-color)" }} className=' text-center fs-1 mb-0'>Adena Collection
                </h1>
                <p className=' fs-5 text-center' style={{ fontFamily: 'var(--secondary-font)', color: "var(--icon-color)",opacity:"0.6" }}>Explore our newly launched collection</p>
